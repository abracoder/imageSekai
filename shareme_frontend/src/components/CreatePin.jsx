  ...
  return (
    <div className="flex flex-col justify-center items-center mt-5 lg:h-4/5">
      ...
      <div className="flex lg:flex-row flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5  w-full">
        <div className="flex bg-seconaryColor p-3 flex-0.7 w-full">
          <div className=" flex justify-center items-center flex-col border-2 border-dotted border-gray-300 p-3 w-full h-420">
            ...
            <div className="flex flex-1 flex-col gap-4 lg:pl-5 mt-5 w-full   justify-center">
              <input type="text"
              value={title}
                ...
                <div>
                  ...
                  >
                    ...
                    {categories.map((category)=>(
                      <option value={category.name} key={category.name} className='text-base border-0 outline-none capitalize bg-white text-black'>{category.name}
                      </option>
                    ))}
                  </select>
                </div>
